...
def nj_url_list(url_list):
    keywords = ["new-jersey", "nj", "jersey", "big-brook", "raritan", "magothy", "merchantville", "woodbury", "englishtown", "marshalltown", "wenonah", "mount-laurel", "mt-laurel", "navesink", "red-bank", "tinton", "new-egypt", "monmouth-co", "monmouth-county", "ramanessin", "hop-brook", "willow-brook", "c-and-d", "cooper-river", "timber-creek"]
    nj_urls = []
...
def main(path):
    ...
    for url in nj_urls:
        ...
        new_path = os.path.join(path, url.split("topic/")[-1])
...
main("C:/Users/19084/Desktop/Forum/Fossil ID")

#main("C:/Users/19084/Desktop/Forum/Fossil Hunting Trips")
#main("C:/Users/19084/Desktop/Forum/General Fossil Discussion")
#main("C:/Users/19084/Desktop/Forum/Microfossils")
#main("C:/Users/19084/Desktop/Forum/NJ Topics")
#main("C:/Users/19084/Desktop/Forum/Albums")
#main("C:/Users/19084/Desktop/Forum/Member Collections")